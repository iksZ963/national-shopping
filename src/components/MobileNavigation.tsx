...
const MobileNavigation = () => {
  return (
    <>
      <div className="w-full pt-12 sm:pt-16 lg:pt-24 fixed bottom-0">
        {/* <!-- nav - start --> */}
        <nav className="sticky bottom-0 mx-auto w-full sm:max-w-md">
          <a
            href="#"
            className="absolute -top-7 left-1/2 flex h-14 w-14 -translate-x-1/2 items-center justify-center rounded-3xl bg-primary text-white shadow-lg transition duration-100 hover:bg-indigo-600 sm:-top-8 sm:h-16 sm:w-16"
          >
            <svg
              className="h-6 w-6"
            ...
            >
              ...
              >
                <path
                  ...
                  d="M21 16V8a2 2 0 00-1.105-1.789l-7-3.5a2 2 0 00-1.79 0l-7 3.5A2 2 0 003 8v8a2 2 0 001.105 1.789l7 3.5a2 2 0 001.79 0l7-3.5A2 2 0 0021 16z"
                />
                <path
                  strokeLinecap="round"
                  strokeLinejoin="round"

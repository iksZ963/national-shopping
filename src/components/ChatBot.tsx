...
const ChatBot = () => {
  ...
  return (
    <>
      ...
      <Card
        className={`fixed bottom-[calc(4rem+1.5rem)] shadow-2xl right-0 mr-4 p-6 rounded-lg border w-[440px] h-[634px] transition-opacity duration-300 ${
      ...
      >
        ...
        <div className="flex flex-col space-y-1.5 pb-6">
          ...
          <p className="text-sm text-[#6b7280] leading-3">Powered by Royal IT BD</p>
        </div>

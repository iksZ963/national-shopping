...
const Footer = () => {
    return (
        <>
            <Card className="pt-4 sm:pt-10 lg:pt-12 border-b-0">
                <footer className="container p-4 md:p-[2rem] mx-auto">
                        ...
                        <div className="col-span-full lg:col-span-2">
                            ...
                            <div className="mb-4 lg:-mt-2">
                                <a href="/" className="inline-flex items-center gap-2 text-xl font-bold text-black md:text-2xl" aria-label="logo">
                                    <Image width={200} height={60} src="/images/logo1.jpg" alt="logo" />
                                </a>
                            </div>
                            {/* <!-- logo - end --> */}
                    ...
                    <div className="border-t py-8 text-center text-sm text-gray-400">
                        © {new Date().getFullYear()} - Royal IT BD. All rights reserved.
                    </div>
